...
const WaitingListForm: React.FC<WaitingListFormProps> = ({ isOpen, onClose, targetAudience = 'demand' }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title={config.waitingListConfig.title}>
